...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"VisoMaster-ZH-2.0", None))
        ...
        self.actionView_Fullscreen_F11.setText(QCoreApplication.translate("MainWindow", u"全屏视图 (F11)", None))
        self.actionTest.setText(QCoreApplication.translate("MainWindow", u"测试", None))
        self.actionLoad_Saved_Workspace.setText(QCoreApplication.translate("MainWindow", u"加载已保存的工作区", None))
        ...
        self.actionLoad_SavedWorkspace.setText(QCoreApplication.translate("MainWindow", u"加载已保存的工作区", None))
        ...
        self.facesPanelCheckBox.setText(QCoreApplication.translate("MainWindow", u"人脸面板", None))
        self.parametersPanelCheckBox.setText(QCoreApplication.translate("MainWindow", u"参数面板", None))
        self.faceCompareCheckBox.setText(QCoreApplication.translate("MainWindow", u"查看人脸对比", None))
        self.faceMaskCheckBox.setText(QCoreApplication.translate("MainWindow", u"查看人脸遮罩", None))
...
#if QT_CONFIG(tooltip)
        self.viewFullScreenButton.setToolTip(QCoreApplication.translate("MainWindow", u"全屏视图 (F11)", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.saveImageButton.setText(QCoreApplication.translate("MainWindow", u"保存图片", None))
        ...
        self.input_Target_DockWidget.setWindowTitle(QCoreApplication.translate("MainWindow", u"目标视频和输入人脸", None))
...
#if QT_CONFIG(tooltip)
        self.filterWebcamsCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"包含摄像头", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.face_editor_tab), QCoreApplication.translate("MainWindow", u"人脸编辑", None))
        ...
        self.clearMemoryButton.setText(QCoreApplication.translate("MainWindow", u"清理显存", None))
